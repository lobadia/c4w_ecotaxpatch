...
//         */
//        if (((bool)Tools::isSubmit('submitC4w_ecotaxpatchModule')) == true) {
//            $this->postProcess();
//        }
//
...
//        $helper->submit_action = 'submitC4w_ecotaxpatchModule';
...
//                        'name' => 'C4W_ECOTAXPATCH_LIVE_MODE',
//                        'is_bool' => true,
...
//                        'name' => 'C4W_ECOTAXPATCH_ACCOUNT_EMAIL',
//                        'label' => $this->l('Email'),
//                    ),
//                    array(
//                        'type' => 'password',
//                        'name' => 'C4W_ECOTAXPATCH_ACCOUNT_PASSWORD',
...
//    {
//        return array(
//            'C4W_ECOTAXPATCH_LIVE_MODE' => Configuration::get('C4W_ECOTAXPATCH_LIVE_MODE', true),
//            'C4W_ECOTAXPATCH_ACCOUNT_EMAIL' => Configuration::get('C4W_ECOTAXPATCH_ACCOUNT_EMAIL', 'contact@prestashop.com'),
//            'C4W_ECOTAXPATCH_ACCOUNT_PASSWORD' => Configuration::get('C4W_ECOTAXPATCH_ACCOUNT_PASSWORD', null),
//        );
//    }
